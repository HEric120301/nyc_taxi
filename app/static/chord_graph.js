...
var chord_svg = d3.select("#chord_graph").append('svg')
      .attr('width', 100)
      .attr('height', 100),
    width = +chord_svg.attr("width"),
    height = +chord_svg.attr("height"),
...
var group = g.append("g")
    .attr("class", "groups")
  .selectAll("g")
  .data(function(chords) {console.log(chords.groups); return chords.groups; })
  .enter().append("g");
